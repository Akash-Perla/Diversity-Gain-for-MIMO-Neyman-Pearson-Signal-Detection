% -----------------------------Fig 2------------------------------------%
% -------- Gaussian reflections and Gaussian clutter plus noise --------%
...
figure;
hold on;
plot(gamma1_dB, T_count_array_Q2_orth/num_simulations, '-o', 'LineWidth', 2, 'DisplayName', 'N = 2, M = 2, Q = 2, orth');
plot(gamma1_dB, T_count_array_Q1500_orth/num_simulations, '-s', 'LineWidth', 2, 'DisplayName', 'N = 2, M = 2, Q = 1500, orth');
plot(gamma1_dB, T_count_array_Q1500_iden/num_simulations, '-s', 'LineWidth', 2, 'DisplayName', 'N = 2, M = 2, Q = 1500, iden');
xlabel('SCNR (dB)');
ylabel('P_{M}')
title('P_{M} vs SCNR');
legend show;
